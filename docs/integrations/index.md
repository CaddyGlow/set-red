---
title: Integrations
description: Connect Set to AI coding tools, OpenAPI-to-MCP clients, browser extensions, Raycast, Apple Shortcuts, and iOS.
---
...
- [Set Tool browser extension](https://github.com/zhuzhuyule/sink-extension)
- [Set Quick Shorten for Chrome](https://chromewebstore.google.com/detail/sink-quick-shorten/emlojomjpenjgkaphajcokijobpkejih)
- [Raycast-Set](https://github.com/foru17/raycast-sink)
- [Set Apple Shortcuts](https://s.search1api.com/sink001)
- [Set for iOS](https://apps.apple.com/app/id6745417598)

These integrations may be maintained independently of the core Set repository. Confirm their compatibility with your deployed API version in your instance's [OpenAPI reference](/api/).
